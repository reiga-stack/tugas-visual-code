...
print(list_buah)
#tambah data indek mana pun dalam list
list_buah.insert(2,'manggis')
print(list_buah)
list_angka=[1,2,3,4,5]
print(list_angka)
#hapus satu angka di belakang
angka_yang_terapus=list_angka.pop()
print('angka yang di hapus:',angka_yang_terapus)
print(list_angka) 
list_buah=['mangga','jambu','jeruk','jambu']
print(list_buah)
#hapus item pertama dengan nilai 'jamabu'
